    ...
    <div class="container">
        <div class="row justify-content-center my-3">
            <div class="col-md-6 shadow-lg p-4">
                <h5 class="text-center text-uppercase fw-bold text-dark">Signup for Journalist</h5>
                <form class=" my-4"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="bio" id="" cols="20" rows="5" aria-describedby="validationServerUsernameFeedback" required>
                            </textarea>
                            <?php 
                                if ($errors != '') {
                                    echo '
                        ...
                        <div class="row gx-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" name="phone" class="form-control" id="email" placeholder="" aria-describedby="validationServerUsernameFeedback" required>
                                <?php 
                                if ($errors != '') {
                                    echo '
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
